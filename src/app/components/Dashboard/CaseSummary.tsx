...
const CaseSummary: React.FC<CaseSummaryProps> = ({ result}) => {
  if (!result) return <p>No hay resultados disponibles.</p>;
        ...
        <div key={result.id} className="border-b border-gray-200 pb-4 mb-4">
          <div className="flex justify-between mt-3">
            ...
            <div className="w-1/2 pl-2">
              <h4 className="text-md font-semibold mb-2">Imagen de la IA</h4>
              <ImageMagnifier src={result.processedImageUrl}   />
            </div>
          </div>
          <div>
            <p><strong>Tipo de IA:</strong> {result.IA_Type}</p>
